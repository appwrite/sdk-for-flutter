...
part 'src/models/provider_repository_list.dart';
part 'src/models/branch_list.dart';
...
part 'src/models/firebase_project_list.dart';
...
part 'src/models/provider_repository.dart';
part 'src/models/detection.dart';
part 'src/models/branch.dart';
...
part 'src/models/firebase_project.dart';
