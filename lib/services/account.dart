...
class Account extends Service {
  ...
  /// apps.
  Future<models.Oauth2ConsentList> listConsents({List<String>? queries, bool? total}) async {
  ...
  Future<models.Oauth2Consent> getConsent({required String consentId}) async {
    final String apiPath = '/account/consents/{consentId}'.replaceAll('{consentId}', consentId);
  ...
  /// are never returned.
  Future<models.Oauth2ConsentTokenList> listConsentTokens({required String consentId, List<String>? queries, bool? total}) async {
    final String apiPath = '/account/consents/{consentId}/tokens'.replaceAll('{consentId}', consentId);
  ...
  Future<models.Oauth2ConsentToken> getConsentToken({required String consentId, required String tokenId}) async {
    final String apiPath = '/account/consents/{consentId}/tokens/{tokenId}'.replaceAll('{consentId}', consentId).replaceAll('{tokenId}', tokenId);
  ...
  Future deleteConsentToken({required String consentId, required String tokenId}) async {
    final String apiPath = '/account/consents/{consentId}/tokens/{tokenId}'.replaceAll('{consentId}', consentId).replaceAll('{tokenId}', tokenId);
