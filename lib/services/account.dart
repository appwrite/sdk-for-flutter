...
class Account extends Service {
  ...
  Future<models.BillingAddressList> listBillingAddresses(
  ...
  Future<models.BillingAddress> createBillingAddress(
  ...
  Future<models.BillingAddress> getBillingAddress(
    ...
    final String apiPath = '/account/billing-addresses/{billingAddressId}'
  ...
  Future<models.BillingAddress> updateBillingAddress(
