...
class Organizations extends Service {
  ...
  Future<models.BillingAddress> getBillingAddress({required String organizationId, required String billingAddressId}) async {
    final String apiPath = '/organizations/{organizationId}/billing-addresses/{billingAddressId}'.replaceAll('{organizationId}', organizationId).replaceAll('{billingAddressId}', billingAddressId);
  ...
  /// 
  Future<models.DowngradeFeedback> createDowngradeFeedback({required String organizationId, required String reason, required String message, required String fromPlanId, required String toPlanId}) async {
    final String apiPath = '/organizations/{organizationId}/feedbacks/downgrade'.replaceAll('{organizationId}', organizationId);
  ...
  Future<models.PaymentMethod> getPaymentMethod({required String organizationId, required String paymentMethodId}) async {
    final String apiPath = '/organizations/{organizationId}/payment-methods/{paymentMethodId}'.replaceAll('{organizationId}', organizationId).replaceAll('{paymentMethodId}', paymentMethodId);
