...
class Teams extends Service {
  ...
  Future<models.AppInstallationList> listInstallations({required String teamId, List<String>? queries, bool? total}) async {
    final String apiPath = '/teams/{teamId}/installations'.replaceAll('{teamId}', teamId);
  ...
  Future<models.AppInstallation> createInstallation({required String teamId, required String appId, String? authorizationDetails}) async {
    final String apiPath = '/teams/{teamId}/installations'.replaceAll('{teamId}', teamId);
  ...
  /// read installations.
  Future<models.AppInstallation> getInstallation({required String teamId, required String installationId}) async {
    final String apiPath = '/teams/{teamId}/installations/{installationId}'.replaceAll('{teamId}', teamId).replaceAll('{installationId}', installationId);
  ...
  Future<models.AppInstallation> updateInstallation({required String teamId, required String installationId, String? authorizationDetails}) async {
    final String apiPath = '/teams/{teamId}/installations/{installationId}'.replaceAll('{teamId}', teamId).replaceAll('{installationId}', installationId);
  ...
  /// access tokens are revoked.
  Future deleteInstallation({required String teamId, required String installationId}) async {
    final String apiPath = '/teams/{teamId}/installations/{installationId}'.replaceAll('{teamId}', teamId).replaceAll('{installationId}', installationId);
