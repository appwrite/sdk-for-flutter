...
class Teams extends Service {
  ...
  /// 
  Future<models.Membership> createMembership({required String teamId, required List<enums.Roles> roles, String? email, String? userId, String? phone, String? url, String? name}) async {
    final String apiPath = '/teams/{teamId}/memberships'.replaceAll('{teamId}', teamId);
  ...
  /// 
  Future<models.Membership> updateMembership({required String teamId, required String membershipId, required List<enums.Roles> roles}) async {
    final String apiPath = '/teams/{teamId}/memberships/{membershipId}'.replaceAll('{teamId}', teamId).replaceAll('{membershipId}', membershipId);
