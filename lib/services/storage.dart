...
class Storage extends Service {
    ...
    ///
    Uri getFileDownload({required String bucketId, required String fileId}) {
    ...
    Future<Uint8List> getFileDownloadBytes({required String bucketId, required String fileId}) async {
        final uri = getFileDownload(
            bucketId: bucketId,
            fileId: fileId,
        );
    ...
    ///
    Uri getFilePreview({required String bucketId, required String fileId, int? width, int? height, String? gravity, int? quality, int? borderWidth, String? borderColor, int? borderRadius, double? opacity, int? rotation, String? background, String? output}) {
    ...
    Future<Uint8List> getFilePreviewBytes({required String bucketId, required String fileId, int? width, int? height, String? gravity, int? quality, int? borderWidth, String? borderColor, int? borderRadius, double? opacity, int? rotation, String? background, String? output}) async {
        final uri = getFilePreview(
            bucketId: bucketId,
            fileId: fileId,
            width: width,
            height: height,
    ...
    /// header.
    ///
    Uri getFileView({required String bucketId, required String fileId}) {
    ...
    Future<Uint8List> getFileViewBytes({required String bucketId, required String fileId}) async {
        final uri = getFileView(
            bucketId: bucketId,
            fileId: fileId,
        );
