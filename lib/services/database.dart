...
class Database extends Service {
    /// Initializes a [Database] service
    Database(super.client);
    ...
    /// modes](/docs/admin).
    Future<models.DocumentList> listDocuments({required String collectionId, List<String>? queries, int? limit, int? offset, String? cursor, String? cursorDirection, List<String>? orderAttributes, List<String>? orderTypes}) async {
    ...
    Future<models.Document> createDocument({required String collectionId, required String documentId, required Map data, List<String>? read, List<String>? write}) async {
        final String path = '/database/collections/{collectionId}/documents'.replaceAll('{collectionId}', collectionId);
    ...
    Future<models.Document> updateDocument({required String collectionId, required String documentId, required Map data, List<String>? read, List<String>? write}) async {
        final String path = '/database/collections/{collectionId}/documents/{documentId}'.replaceAll('{collectionId}', collectionId).replaceAll('{documentId}', documentId);
