...
void main() {
    group('Tables test', () {
        ...
        test('test method createRow()', () async {
            ...
            final response = await tables.createRow(
                databaseId: '<DATABASE_ID>',
                tableId: '<TABLE_ID>',
                rowId: '<ROW_ID>',
                data: {},
        ...
        test('test method createRows()', () async {
            ...
            final response = await tables.createRows(
                databaseId: '<DATABASE_ID>',
                tableId: '<TABLE_ID>',
                rows: [],
            );
        ...
        test('test method getRow()', () async {
            ...
            final response = await tables.getRow(
                databaseId: '<DATABASE_ID>',
                tableId: '<TABLE_ID>',
                rowId: '<ROW_ID>',
            );
        ...
        test('test method upsertRow()', () async {
            ...
            final response = await tables.upsertRow(
                databaseId: '<DATABASE_ID>',
                tableId: '<TABLE_ID>',
                rowId: '<ROW_ID>',
            );
        ...
        test('test method updateRow()', () async {
            ...
            final response = await tables.updateRow(
                databaseId: '<DATABASE_ID>',
                tableId: '<TABLE_ID>',
                rowId: '<ROW_ID>',
            );
        ...
        test('test method deleteRow()', () async {
            ...
            final response = await tables.deleteRow(
                databaseId: '<DATABASE_ID>',
                tableId: '<TABLE_ID>',
                rowId: '<ROW_ID>',
            );
