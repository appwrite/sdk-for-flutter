...
void main() {
  group('Avatars test', () {
    ...
    test('test method getFavicon()', () async {
      ...
      final response = await avatars.getFavicon(url: 'https://example.com');
      expect(response, isA<Uint8List>());
    });
    ...
    test('test method getFlag()', () async {
      ...
      final response = await avatars.getFlag(code: enums.Flag.afghanistan);
      expect(response, isA<Uint8List>());
    });
    ...
    test('test method getImage()', () async {
      ...
      final response = await avatars.getImage(url: 'https://example.com');
      expect(response, isA<Uint8List>());
    });
    ...
    test('test method getQR()', () async {
      ...
      final response = await avatars.getQR(text: '<TEXT>');
      expect(response, isA<Uint8List>());
    });
    ...
    test('test method getScreenshot()', () async {
      ...
      final response = await avatars.getScreenshot(url: 'https://example.com');
      expect(response, isA<Uint8List>());
    });
  });
}
