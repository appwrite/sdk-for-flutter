...
void main() {
  group('Locale test', () {
    ...
    test('test method listCodes()', () async {
      final Map<String, dynamic> data = {'total': 5, 'localeCodes': []};
    ...
    test('test method listContinents()', () async {
      final Map<String, dynamic> data = {'total': 5, 'continents': []};
    ...
    test('test method listCountries()', () async {
      final Map<String, dynamic> data = {'total': 5, 'countries': []};
    ...
    test('test method listCountriesPhones()', () async {
      final Map<String, dynamic> data = {'total': 5, 'phones': []};
    ...
    test('test method listCurrencies()', () async {
      final Map<String, dynamic> data = {'total': 5, 'currencies': []};
    ...
    test('test method listLanguages()', () async {
      final Map<String, dynamic> data = {'total': 5, 'languages': []};
